...
- The chatbot uses a compact mobile panel with safe-area positioning, Escape-to-close, input autofocus, and visible keyboard focus; preserve these behaviors when editing `components/Chatbot.tsx`.
